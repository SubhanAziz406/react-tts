...
const Dsoundeffect = () => {
     ...
     <header className="py-12">
        <div className="max-w-7xl mx-auto text-center px-6">
          <h1 className="text-2xl font-extrabold text-gray-900" style={{paddingTop: "20vh"}}>
            Transform Your Text into <br /> Stunning   <span className="header-caption">
    <span className="cd-headline rotate-1">
      <span className="cd-words-wrapper">
        <b className="is-visible theme-gradient"><h1>Sound Effect</h1></b>
  ...
  >
    <textarea
      ...
      className="form-control h-100     rounded "
      style={{
          color:'black',
