...
const Meeting = () => {
  ...
  const startMeeting = () => {
    if (meetingUrl && meetingUrl.startsWith('https://meet.google.com/')) {
      window.location.href = meetingUrl; // Redirect to the Google Meet page
    } else {
      alert('Please enter a valid Google Meet URL (e.g., https://meet.google.com/xxx-xxxx-xxx)');
    }
  };
          ...
          <div className="d-flex flex-column justify-content-center align-items-center">
            ...
            <div className="additional text-white mt-4">
              <p className="additional">
                <strong className="additional">Meeting URL:</strong> {meetingUrl}
              </p>
            </div>
          </div>
